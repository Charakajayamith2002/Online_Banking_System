...
<body>
   <header>
        ...
        <ul>
            <li><a href="#"><img src="images/homeNav/person-circle.svg" alt=""></a></li>
            <li><a href="#"><img src="images/homeNav/bell.svg" alt=""></a></li>
            <li><a href="#"><img src="images/homeNav/gear.svg" alt=""></a></li>
    ...
    <section style="background-image: url(images/home/homebg.jpg); height:700px;">

       
	<div>
		<a href="onetime_transfer.jsp">
			<button type="button">One Time Transfer</button>
		</a> 
		<a href="favoriteFundTransfer.jsp">
			<button type="button">Favorite Transfer</button>
		</a>
