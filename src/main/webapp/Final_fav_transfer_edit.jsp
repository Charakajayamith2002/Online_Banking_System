...
<body>
<header>
        <a href="index.jsp" class="logo"><img src="images/hi.jpg"  alt=""></a>

        <ul>
            <li><a href="updateCustomerDetails.jsp"><img src="images/homeNav/person-circle.svg" alt=""></a></li>
            <li><a href="#"><img src="images/homeNav/bell.svg" alt=""></a></li>
            <li><a href="DeleteCustomerDetails.jsp"><img src="images/homeNav/gear.svg" alt=""></a></li>
            <li><a href="index.jsp"><img src="images/homeNav/exit.svg" alt=""></a></li>
    ...
    <label for="sidebarcheck">
        <img src="images/homeNav/list.svg" alt="" id="btn">
        <img src="images/homeNav/x.svg" alt="" id="x">
    ...
    <!-- content -->
     ...
     <section style="background-image: url(images/home/homebg.jpg); height:800px;">
     <div class="goback"><button onclick="history.back()">Go Back</button></div>
     
	<div class="form">
		<div class="title">Update</div>

		<!-- UpdateFavoriteTransferServlet -->
		<form action="UpdateFavorite" method="post">
