...
<link rel="stylesheet" href="styles/deleteCustomerDetails.css">
...
<body>
	...
	<section
		...
		<form action="DeleteCustomer" method="post">
			...
			<h3>Name</h3>
			<input type="text" name="name" value="<%=cusDetails.getName()%>"
				readonly><br>
			<h3>Email</h3>
			<input type="text" name="email" value="<%=cusDetails.getEmail()%>"
				readonly><br>
			<h3>Phone Number</h3>
			<input type="text" name="phone" value="<%=cusDetails.getPhone()%>"
				readonly><br>
			<h2>NIC</h2>
			...
			<input type="password" name="password"
				value="<%=cusDetails.getPassword()%>" readonly><br> <input
				type="submit" name="submit" value="Delete My Account">
